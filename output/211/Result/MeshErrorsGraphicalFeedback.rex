...
<MetaResultFile version="20211011" creator="Solver">
  ...
  <AuxResultFile filename="MeshErrorsGraphicalFeedback.axg" add_to_tree="1" default="1"/>
  <FieldFreeNodes/>
  ...
  <InfoText num_lines="7">
    ...
    <InfoTextLine key="Tetrahedrons" value="34,592" visible="1"/>
    <InfoTextLine key="Min. edge length" value="0.0260267" visible="0"/>
    <InfoTextLine key="Max. edge length" value="3.48822" visible="0"/>
    <InfoTextLine key="Min. quality" value="0.00146661" visible="0"/>
    <InfoTextLine key="Max. quality" value="0.993967" visible="0"/>
    <InfoTextLine key="Avg. quality" value="0.609219" visible="0"/>
  </InfoText>
  <AutoScale>
